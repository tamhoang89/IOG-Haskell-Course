...
data Maze = Exit | Wall | Step { left    :: Maze,
                                 forward :: Maze,
                                 right   :: Maze } 
            deriving Show
...
move Wall _ = Wall
move Exit _ = Exit
move maze GoLeft = left maze
move maze GoForward = forward maze
move maze GoRight = right maze
...
solveMaze' maze moves = showCurrentChoice $ solveMaze maze moves

move1 = [GoLeft] :: [Move]
move2 = [GoLeft, GoRight] :: [Move]
move3 = [GoForward, GoRight] :: [Move]
move4 = [GoForward, GoLeft] :: [Move]
move5 = [GoRight, GoForward, GoLeft] :: [Move]
move6 = [GoRight, GoForward, GoLeft, GoRight] :: [Move]